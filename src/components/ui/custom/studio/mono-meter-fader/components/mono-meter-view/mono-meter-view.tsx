...
// Function for drawing mono meter
const drawMonoMeter = (
...
export const MonoMeterView = ({
  ...
  useRequestAnimationFrame(
    () => {
      ...
      drawMonoMeter(canvasRef, height, width, smoothedValue, peak, peakColor);
    },
    {
      enabled: active,
    }
  ...
  return (
    <div
      style={{ width, height }}
      className="absolute bg-surface-1 h-full border border-surface-4"
    >
