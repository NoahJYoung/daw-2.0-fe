      ...
      <section className="bg-surface-0 text-foreground p-1">
        ...
        >
          ...
          <PanelResizeHandle
            ...
            className="h-2 ml-[2px] bg-surface-1 border-0 border-surface-0"
          />
          <div className="flex bg-surface-1 ml-[2px] pl-[4px] w-full items-start h-[48px] sm:gap-5 justify-between md:justify-start">
            <StudioButton
          ...
          <Panel
            className="bg-surface-1 ml-[2px] w-full lg:px-12"
            order={2}
            ref={bottomPanelRef}
            defaultSize={45}
            maxSize={100}
