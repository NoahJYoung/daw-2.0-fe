...
export class Transport extends ExtendedModel(BaseAudioNodeWrapper, {
  ...
  sync() {
    this.toneTransport.bpm.value = Math.round(this.bpm);
    this.toneTransport.timeSignature = this.timeSignature;
