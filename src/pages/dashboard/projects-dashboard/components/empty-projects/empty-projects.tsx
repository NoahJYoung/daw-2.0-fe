...
export const EmptyProjects = () => {
  return (
    <div className="mx-3 flex h-full lg:h-[400px] flex-col items-center justify-center rounded-md border border-dashed p-2 lg:p-8 text-center animate-in fade-in-50">
      <div className="mx-auto flex w-10 h-10 lg:h-20 lg:w-20 items-center justify-center rounded-full bg-muted">
        <Music className="md:h-10 md:w-10 text-muted-foreground" />
      </div>
